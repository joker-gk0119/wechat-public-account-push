...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wxb4aa9940b85f6dc0',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: '32662d9d474808416ef0fb7f2e9a15ab',
  ...
  USERS: [
    {
      ...
      festivals: [
        ...
        {
          type: '*生日', name: '老婆', year: '1999', date: '10-14',
        },
      ],
  ...
  CALLBACK_TEMPLATE_ID: 'o51DL58V7gqNhvP0YWVJtRYHvmz0',
  ...
  CALLBACK_USERS: [
    {
      ...
      id: 'o51DL58V7gqNhvP0YWVJtRYHvmz0',
    }
    // 你可以不断按格式往下增加
    // ...
  ],
  ...
  FESTIVALS: [
    // 注意：此条配置日期为阴历日期，因为`type`中 “生日” 之前有 * 符号
    {
      type: '*生日', name: '老婆', year: '1999', date: '10-14', isShowAge: false,
    },
    // 你可以不断按格式往下增加
    // ...
  ],
  ...
  CUSTOMIZED_DATE_LIST: [
    ...
    { keyword: 'love_day', date: '2022-03-06' },
    // 生日倒计时
    { keyword: 'birthday_left', date: '10-14' },
    // 你可以不断按格式往下增加
    // ...
  ],
